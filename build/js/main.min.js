...
var _cruises = require("./modules/cruises");
// ---------------------------------
...
},{"./modules/cruises":2,"./modules/form-validate/form":4,"./modules/header":10,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fixCruises = void 0;
var fixCruises = function fixCruises() {
  var cruises = document.querySelectorAll('[data-hover="card"]');
  cruises.forEach(function (cruise) {
    var innerCard = cruise.querySelector('[data-hover="inner"]');
    var outerCard = cruise.querySelector('[data-hover="outer"]');
    var button = cruise.querySelector('[data-hover="button"]');
    var focus = false;
    cruise.addEventListener('mouseenter', function () {
      innerCard.classList.add('cruises__inner-card--visible');
    });
    cruise.addEventListener('mouseleave', function () {
      if (!focus) {
        setTimeout(function () {
    ...
    cruise.addEventListener('focusin', function () {
      focus = true;
      innerCard.classList.add('cruises__inner-card--visible');
      innerCard.classList.add('opacity-1');
      outerCard.classList.add('opacity-0');
    });
    cruise.addEventListener('focusout', function (event) {
...
var initNav = function initNav() {
  var lockScroll = new _scrollLock.ScrollLock();
  var lockFocus = new _focusLock.FocusLock();
  var openButton = document.querySelector('[data-header="open"]');
  var navigation = document.querySelector('[data-header="container"]');
  var closeButton = navigation.querySelector('[data-header="close"]');
  var oldLogo = document.querySelector('[data-header="logo"]');
  var body = document.querySelector('body');
  var breakpoint = window.matchMedia('(min-width:768px)');
  var linkBreakpoint = window.matchMedia('(max-width:767px)');
  var links = document.querySelectorAll('[data-header="link"]');
  ...
  var closeNavigation = function closeNavigation() {
    var backdrop = body.querySelector('.background-drop');
    if (backdrop) {
      backdrop.classList.add('background-drop--fading');
    }
  ...
  var closeNavigationHandler = function closeNavigationHandler() {
    closeNavigation();
